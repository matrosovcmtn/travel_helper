export const DAYS = [
  ...
  },
  {
    ...
    color: "#bb5588", icon: "🏯",
    items: [
      { time: "10:00", text: "Императорский дворец — Higashi Gyoen", sub: "Восточные сады, остатки замка Эдо — бесплатно" },
      { time: "13:00", text: "Обед рядом (Отэмати / Гиндза)" },
      { time: "14:30", text: "Гиндза", sub: "Шоппинг, витрины, флагманские магазины (Uniqlo, Ginza Six)" },
  ...
  },
  {
    ...
    color: "#7766aa", icon: "🗻",
    items: [
      { time: "7:30", text: "Romancecar Синдзюку → Хаконэ-Юмото", sub: "Ранний поезд, чтобы успеть весь маршрут за день" },
      { time: "9:30", text: "Горная ж/д Tozan → Гора", sub: "Зигзаги-развороты, живописно" },
      { time: "11:00", text: "Фуникулёр + канатка → Овакудани", sub: "Вулканическая долина, чёрные яйца, в ясную погоду виден Фудзи" },
      { time: "13:00", text: "Канатка → Тогэндай, кораблик по озеру Аси → Мото-Хаконэ", sub: "По Hakone Freepass" },
      { time: "14:30", text: "Святилище Хаконэ", sub: "Знаменитые тории на воде (Хэйва-но-Тории), прямо у пристани в Мото-Хаконэ" },
      { time: "16:00", text: "Автобус Мото-Хаконэ → Гора", sub: "По Hakone Freepass" },
  ...
  },
  {
    ...
    items: [
      ...
      { time: "", text: "Гора → Одавара → Офуна → Камакура (JR)", sub: "~1ч, напрямую, без заезда в Токио" },
      { time: "", text: "Большой Будда (Котоку-ин) + Хасэдэра", sub: "Дайбуцу 13 м, вид на залив из Хасэдэра" },
      { time: "", text: "Трамвай Энодэн → Эносима", sub: "Самый живописный участок вдоль моря" },
      { time: "", text: "Остров Эносима", sub: "Святилище, смотровая Sea Candle, закат над заливом" },
      { time: "Вечер", text: "Возврат в Токио", sub: "~1ч15м на электричке до Airbnb (Сугинами)" },
